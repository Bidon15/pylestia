...
class Blob:
    ...
    def __init__(
        ...
        index: int | None = None,
        signer: Base64 | str | bytes | None = None,
    ):
        ...
        if commitment is not None:
            ...
            try:
                try:
                    ...
                    try:
                        kwargs = ext.normalize_blob(
                            self.namespace, self.data, self.signer
                        )
                    except TypeError:
                    ...
                    if share_version is not None:
                        ...
                        self.share_version = kwargs.get(
                            "share_version", 0 if self.signer is None else 1
                        )
