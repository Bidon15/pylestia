...
from pylestia.types.p2p import (
    BandwidthStats,
    Connectedness,
    AddrInfo,
    Reachability,
...
class P2PClient(Wrapper):
    ...
    async def bandwidth_for_peer(
        ...
        deserializer = (
            deserializer if deserializer is not None else BandwidthStats.deserializer
        )
    ...
    async def bandwidth_for_protocol(
        ...
        return await self._rpc.call(
            "p2p.BandwidthForProtocol", (protocol_id,), deserializer
        )
    ...
    async def info(self, *, deserializer: Callable | None = None) -> AddrInfo:
        ...
        deserializer = (
            deserializer if deserializer is not None else AddrInfo.deserializer
        )
    ...
    async def resource_state(
        ...
        deserializer = (
            ...
            else ResourceManagerStat.deserializer
        )
